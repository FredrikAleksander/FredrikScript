...
//            let pArgs : Parser<Expression list> = sepBy pExpression (pKeywordComma .>> pWhitespace)
...
//            |>> (fun (identifier, vc) ->
//                match vc with
//                | Some args -> Expression.Call (Expression.SymbolOld(identifier), args)
//                | _ ->  Expression.SymbolOld (identifier))
