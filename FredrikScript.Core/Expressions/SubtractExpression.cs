...
namespace FredrikScript.Core.Expressions
{
    ...
    {
        public SubtractExpression(Context context, SourceInformation sourceInformation, Expression leftValue, Expression rightValue) : base(context, sourceInformation, leftValue, rightValue)
        {
